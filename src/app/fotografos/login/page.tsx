...
export default function PhotographerLoginPage() {
  ...
  return (
    <AuthShell title="Ingresar" subtitle="Panel de fotógrafo en Action Snap">
      ...
      <div className="mt-4 space-y-2 text-center text-xs text-[var(--color-text-secondary)]">
        <p>
          ¿No tenés cuenta?{" "}
          <Link href="/fotografos/registro" className="text-[var(--color-primary)] hover:underline">
            Registrate
          </Link>
        </p>
        <p>
          <Link href="/para-fotografos" className="text-[var(--color-primary)] hover:underline">
